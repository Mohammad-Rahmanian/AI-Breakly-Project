...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        position, corners_list = state[0], state[1]
        return len(corners_list) == 4
        # util.raiseNotDefined()
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.WEST, Directions.SOUTH, Directions.EAST]:
            ...
            if not hitsWall:
                ...
                if (nextx, nexty) in self.corners and (nextx, nexty) not in list(state[1]):
...
def cornersHeuristic(state, problem):
    ...
    for unvisitedCorner in unvisitedCorners:
        heuristic_values.append(mazeDistance(position, unvisitedCorner, problem.startingState))
...
def foodHeuristic(state, problem):
    ...
    for food in foodGrid.asList():
        heuristic_values.append(mazeDistance(position, food, problem.startingGameState))
    return max(heuristic_values)
    # return 0
